...
namespace Infrastructure.ECS.Services
{
    public class InputService
    {
        ...
        public event Action<bool> OnDisableLook;
        ...
        private void SetMouseDirection()
        {
            ...
            _movement.DisableLook.started += ctx => OnDisableLook?.Invoke(true);
            _movement.DisableLook.canceled += ctx => OnDisableLook?.Invoke(false);
        }
